...
<div class="header">
  <div class="main">
    ...
    <div class="nav-user">
      <!-- 未登入状态 -->
      <a class="unlogin" href="<?php echo U('login');?>"><i class="iconfont icon-touxiang"></i></a>
      <span><a href="<?php echo U('login');?>">登入</a><a href="<?php echo U('Reg');?>">注册</a></span>
      <p class="out-login">
  ...
  <div class="wrap">
    <div class="content">
      ...
      <ul class="fly-list">
        ...
        <li class="fly-list-li">
          <a href="user/home.html" class="fly-list-avatar">
            <img src="/wenda/Public/layui/res/images/avatar/00.jpg" alt="">
          </a>
          <h2 class="fly-tip">
        ...
        <li class="fly-list-li">
          <a href="user/home.html" class="fly-list-avatar">
            <img src="/wenda/Public/layui/res/images/avatar/default.png" alt="">
          </a>
          <h2 class="fly-tip">
    ...
    <div class="user-looklog leifeng-rank">
      <span>
        <a href="user/home.html">
          <img src="/wenda/Public/layui/res/images/avatar/default.png">
          <cite>纸飞机</cite>
          <i>159次回答</i>
        </a>
        <a href="user/home.html">
