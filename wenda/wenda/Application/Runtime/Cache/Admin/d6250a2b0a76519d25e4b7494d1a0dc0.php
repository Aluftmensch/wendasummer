	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="alert alert-block alert-success">
				...
				<i class="icon-ok red" style="font-size:30px">欢迎 <?php echo ($_SESSION['adminname']); ?></i>
				...
				<div class="col-sm-5"  >
					<div class="widget-box transparent">
						<div class="widget-header widget-header-flat">
							...
							<div style="float: right;width: 180px;height: 20px">
		<div style="float: left;"><div style="width: 40px; height: 20px;background-color:#16a085;"></div><span>新增用户数量</span></div>
		<div style="float: right;"><div style="clear: both;"></div><div style="width: 40px; height: 20px;background-color:#1693A5;"></div><div style="clear: both;"></div><span style="float: right;">新增问题数量</span></div>
						...
						<div class="widget-body">
							<div class="widget-main no-padding">
                                ...
                                <script src="/wenda/Public/chart/Chart-1.0.1-beta.4.js"></script>
			                	<script type="text/javascript" src="/wenda/Public/jquery.min.js"></script>

		           <script>
			
			var data = {
				labels : ["<?php echo ($date[1]); ?>","<?php echo ($date[2]); ?>","<?php echo ($date[3]); ?>","<?php echo ($date[4]); ?>","<?php echo ($date[5]); ?>","<?php echo ($date[6]); ?>","<?php echo ($date[7]); ?>","<?php echo ($date[8]); ?>","<?php echo ($date[9]); ?>","<?php echo ($date[10]); ?>"],
				datasets : [
					{
						barItemName: "name1",
						fillColor : "#16a085",
						strokeColor : "rgba(220,220,220,1)",
						data : [<?php echo ($day[1]); ?>,<?php echo ($day[2]); ?>,<?php echo ($day[3]); ?>,<?php echo ($day[4]); ?>,<?php echo ($day[5]); ?>,<?php echo ($day[6]); ?>,<?php echo ($day[7]); ?>,<?php echo ($day[8]); ?>,<?php echo ($day[9]); ?>,<?php echo ($day[10]); ?>]
					},
					{
						barItemName: "name2",
						fillColor : "#1693A5",
						strokeColor : "rgba(151,187,205,1)",
						data : [<?php echo ($over[1]); ?>,<?php echo ($over[2]); ?>,<?php echo ($over[3]); ?>,<?php echo ($over[4]); ?>,<?php echo ($over[5]); ?>,<?php echo ($over[6]); ?>,<?php echo ($over[7]); ?>,<?php echo ($over[8]); ?>,<?php echo ($over[9]); ?>,<?php echo ($over[10]); ?>]
					}
				]
			};
