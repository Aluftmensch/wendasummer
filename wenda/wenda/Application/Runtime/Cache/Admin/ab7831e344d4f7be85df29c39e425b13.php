    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="page-header">
                ...
                <form action='/wenda/admin.php/Users/index' method="get">
                    <div class="seachform">
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                   ...
                                   <div id="test" style="display:none;background-color: red;margin: 0 auto"><input type="text" name="name" class="form"></div>
                                    ...
                                    <script type="text/javascript" src="/wenda/Public/jquery.min.js"></script>
                                     ...
                                     function tabledata(){
                                        var html = "";
                                        html+="<?php if(is_array($tusers)): $i = 0; $__LIST__ = $tusers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>";
                                        html+="<tr>";
                                        html+="<td><?php echo ($t["username"]); ?></td>";
                                        html+="<td><?php echo ($t["tel"]); ?></td>";
                                        html+="<td><?php echo ($t["email"]); ?></td>";
                                        html+="<td><?php if(($t["identity"] == 0)): ?>学生<?php else: ?>教师<?php endif; ?></td>";
                                        html+="<td><a class='purple' href='#' id='<?php echo ($t["uid"]); ?>'><i class='icon-user-md bigger-130'>重置密码</i></a><a class='green' id='<?php echo ($t["uid"]); ?>'  href='#'><i class='icon-edit-sign bigger-130'>修改</i></a><a class='red' id='<?php echo ($t["uid"]); ?>' href='#'><i class='icon-trash bigger-130'>删除</i> </a></td>"
                                        html+="</tr>";
                                     ...
                                     function newtabledata(){
                                        ...
                                        $(".table-responsive").html(t);
                                         $.ajax({
                                            url:"/wenda/admin.php/Users/gettdata",
                                            data:"",
                                            type:"POST",
                                            dataType:"json",
                                                ...
                                                var html = "";
                                                  for(var i in msg){
                                                    ...
                                                    if (msg[i].identity==1) {
                                                     ...
                                                     html+="<td><div class='visible-md visible-lg hidden-sm hidden-xs action-buttons'><a class='green' id='<?php echo ($t["uid"]); ?>'  href='#'><i class='icon-pencil bigger-130'>修改</i></a><a class='red' id='<?php echo ($t["uid"]); ?>' href='#'><i class='icon-trash bigger-130'>删除</i> </a></div></td>"
                                 ...
                                 <div id="yahoo2" class="yahoo2" ><?php echo ($page); ?></div>
