...
<div class="main-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-header">
											&nbsp;<a href="javascript:back()"><button class="btn btn-primary btn-xs">返回</button></a>
										</div>
										...
										<div class="table-responsive">
											...
											<tr>
												<td  style="width: 40px;height: 40px"><img src="/wenda/Public/userphoto/<?php echo ($ud['upic']); ?>" alt="头像"></td>
										    ...
										    <tr>
										    	<td align="center">身份信息</td>
										    	<td ><?php if(($ud["identity"] == 0)): ?>学生<?php else: ?>教师<?php endif; ?></td>
										    </tr>
											<tr>
												<td align="center">联系电话</td>
												<td><?php echo ($ud["tel"]); ?></td>
											</tr>
											<tr>
  ...
  <script type="text/javascript">
	function back() {
		window.location.href="<?php echo U('Users/userslist');?>";
	}
</script>
