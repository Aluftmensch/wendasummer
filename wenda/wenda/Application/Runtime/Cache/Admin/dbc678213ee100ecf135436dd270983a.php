...
<a href="/wenda/admin.php/Index/index.html">后台主页</a>
</li>
...
<td class="hidden-480" id="<?php echo ($i); ?>" style="text-align: center;"><?php echo ($t["typename"]); ?></td>
<td style="text-align: center;"><?php echo ($t["createtime"]); ?></td>
<td>
<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
<a class="green" id="<?php echo ($t["tid"]); ?>" name="<?php echo ($i); ?>" href="#">
<i class="icon-pencil bigger-130">修改</i>

</a>

<a class="red" id="<?php echo ($t["tid"]); ?>" href="#">
...
if (confirm('你确定要删除吗？')){
$.ajax({
url:"/wenda/admin.php/Type/deltype",
data:{'tid':id}, 
type:"GET",
dataType:"json",
...
$("#mydiv>div").remove();
$.ajax({
url:"/wenda/admin.php/Type/getdata",
data:{'tid':id},
type:"POST",
dataType:"json",
...
$.ajax({
url:"/wenda/admin.php/Type/doingedit",
