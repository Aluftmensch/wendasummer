							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="form-group form-horizontal">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> 添加公告 </label>

										<div class="col-sm-9">
											<input  type="text"  name="name" class="col-xs-10 col-sm-5" id="form-input-readonly" placeholder="请输入公告内容" required="" />	
										</div>
...
<script type="text/javascript">
	$(function(){
		$("button[name='sub']").click(function(){
            ...
            if(name!=''){
            $.ajax({
            	url:"/wenda/admin.php/Announce/doingadd",
            	data:{'context':name},
            	type:"POST",
            	dataType:"json",
            	success:function(msg){
            		alert(msg);
            		if (confirm(msg)) {
            			window.location.href="<?php echo U('Announce/announcelist');?>";
            		}else{
            			alert('错误');
            		}
